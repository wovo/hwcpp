...
<!-- update table_of_contents( input ) -->
 ...
 - [Source, sink](#toc-anchor-2)

 - [Box : get, set, invalidate, flush](#toc-anchor-3)

 - [Stream : read, write, refresh, flush](#toc-anchor-4)

 - [Class filters](#toc-anchor-5)

 - [Public, Library-internal, File-internal](#toc-anchor-6)

 - [pin_in_out_creator](#toc-anchor-7)

 - [root class, class filter, class creator, mixin class](#toc-anchor-8)

 - [Files](#toc-anchor-9)

 - [Dependencies](#toc-anchor-10)

 - [Static classes](#toc-anchor-11)

 - [include "hwcpp.hpp"](#toc-anchor-12)

 - [Interfaces and concepts](#toc-anchor-13)

 - [Glossary](#toc-anchor-14)
...
## Box : get, set, invalidate, flush
<a name="toc-anchor-4"></a>
## Stream : read, write, refresh, flush
<a name="toc-anchor-5"></a>
## Class filters
<a name="toc-anchor-6"></a>
## Public, Library-internal, File-internal
<a name="toc-anchor-7"></a>
## pin_in_out_creator
<a name="toc-anchor-8"></a>
## root class, class filter, class creator, mixin class
